...
面向企业客户的售后管理与分析平台。当前核心版本包含登录、客户管理、消费分析、2026 服务分析、飞书服务记录镜像，以及飞书售后交接档案的同步、匹配和分组展示。
...
飞书售后交接档案的完整校准、客户匹配、敏感字段保护和密钥轮换见 [飞书售后交接同步运行手册](docs/feishu-handoff-sync.md)。
